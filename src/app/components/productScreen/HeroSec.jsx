        ...
        <div className="grow shrink basis-0  justify-start md:items-center gap-[50px] lg:gap-[131px] flex flex-col md:flex-row">
          <div className="flex-col w-[100%] justify-start items-start gap-[22px] inline-flex">
            <div className="flex-col justify-start items-start gap-3 flex">
              <div className="text-zinc-800 text-3xl md:text-4xl font-semibold  ">
                {productName}
              </div>
            ...
            <div className="justify-start items-start gap-5 md:gap-8 inline-flex flex-wrap">
              <div className="h-11 rounded-lg justify-start items-start flex w-[100%] sm:w-auto">
                <a
